...
const skills = [
  { name: "Python", color: "#3776AB", bg: "#1e3a5f", icon: "🐍" },
  { name: "Flutter", color: "#54C5F8", bg: "#1a3a4a", icon: "📱" },
  { name: "Ubuntu", color: "#E95420", bg: "#3d1a0f", accent: true },
  { name: "Git Source Control", color: "#F05032", bg: "#3d1a0f", icon: "🔀" },
  { name: "ERPNext", color: "#0089FF", bg: "#1a2a3d", icon: "E" },
  { name: "MongoDB", color: "#47A248", bg: "#1a2d1a", icon: "🍃" },
  { name: "Html & CSS", color: "#E34F26", bg: "#3d1a0f", icon: "⚡" },
  { name: "JavaScript", color: "#F7DF1E", bg: "#3d3010", icon: "JS" },
  { name: "Frappe", color: "#5E64FF", bg: "#1e1a4a", icon: "F" },
  { name: ".Net", color: "#512BD4", bg: "#20133d", icon: ".NET" },
  { name: "Flask Microweb Framework", color: "#00d4aa", bg: "#0d2e28", icon: "🌶" },
  { name: "MySql", color: "#4479A1", bg: "#1a2a3d", icon: "🗄" },
  { name: "AWS Server", color: "#FF9900", bg: "#3d2a0a", icon: "☁" },
];
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'Sora', 'Nunito Sans', sans-serif", background: "#1a1a2e", color: "#e8e8f0", minHeight: "100vh", overflowX: "hidden" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", maxWidth: 1100, margin: "0 auto", gap: 40, position: "relative", zIndex: 1 }}>
          <div style={{ flex: 1, maxWidth: 520 }}>
            <FadeIn>
              ...
              <h1 style={{ fontSize: "clamp(48px, 6vw, 76px)", fontWeight: 800, lineHeight: 1.05, color: "#fff", marginBottom: 12 }}>Ivan Dan</h1>
              <p style={{ color: "#d4a843", fontSize: 16, fontWeight: 600, marginBottom: 6, letterSpacing: "0.04em" }}>Python Developer & ERPNext</p>
      ...
      <section style={{ padding: "60px 6%", maxWidth: 1100, margin: "0 auto" }}>
        <FadeIn>
          ...
          <p style={{ color: "#9090b0", lineHeight: 1.9, maxWidth: 750, fontSize: 15 }}>
            I have acquired and sharpened expertise across Python development and ERP systems, building enterprise solutions that scale. Maecenas egit condimentum vn organization. I am trustworthy, creative, and an effective communicator. I fondly anticipate working in a challenging yet rewarding organization to attain its visions for personal growth.
          </p>
        </FadeIn>
      </section>

      {/* SKILLS */}
      <section style={{ padding: "60px 6% 80px", background: "#12122a" }}>
      ...
      {/* EXPERIENCE */}
      <section style={{ padding: "80px 6%", background: "#12122a" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <FadeIn>
